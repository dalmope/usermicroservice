...
public class Constants {
    ...
    public static final String PASSWORD_CHANGED_MESSAGE = "Contraseña cambiada exitosamente";
    public static final String EMAIL_RECOVERY_MESSAGE = "Se ha enviado un correo electrónico para recuperar la contraseña";
