...
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_DESCRIPTION_MESSAGE;
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_LICENSE_NAME_MESSAGE;
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_LICENSE_URL_MESSAGE;
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_TERMS_OF_SERVICE_MESSAGE;
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_TITLE_MESSAGE;
import static co.dalmope.usermicroservice.application.Constants.SWAGGER_VERSION_MESSAGE;
